...
countries_visited= "India,Nepal,Bhutan"
countries_to_visit= "Us, UK,UAE"
num_of_countries_visited= 3

print(f"""I have visited {countries_visited} countries. I plan to visit {countries_to_visit} more countries, 
      and when I'm done I will have visited {num_of_countries_visited} countries.""")
